                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="section-heading">
                        <form method="post" action="upload.php" style="font-size: 20px;" enctype="multipart/form-data"><br><br>
                            ...
                            怪獸蛋圖案：
                            <input type="file" name="egg" required style="width:410px;float:right;display:inline"><br><br>
                            怪獸蛋售出圖案：
                            <input type="file" name="eggDone" required style="width:370px;float:right;display:inline"><br><br>
                            怪獸圖案：
                            <input type="file" name="monster" required style="width:430px;float:right;display:inline"><br><br>
                            <input type="submit" value="送出" name="submit" style="width: 70px;height: 40px; border-radius: 4px;background-color: #70c745; color: white; border-color:#DDDDDD ;">
                        </form>
